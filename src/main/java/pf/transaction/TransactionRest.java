...
public class TransactionRest {
	...
	public String getTransactions(HttpServletRequest request, @RequestParam("account") String accountId) {
		try {
	...
	public String getUpToMonthTransactions(HttpServletRequest request, @RequestParam("year") String year,
			@RequestParam("accountId") String accountId, @RequestParam("month") String month) {
		String jsonString;
		try {
			String userEmail = request.getRemoteUser();
			LOGGER.info("Logged in user email: " + userEmail);
	...
	public String getMonthTransactions(HttpServletRequest request, @RequestParam("year") String year,
			@RequestParam("accountId") String accountId, @RequestParam("month") String month) {
		String jsonString;
		try {
	...
	public String saveTransaction(HttpServletRequest request, @RequestParam("amount") String amount,
		...
		try {
			...
			// FIXME: do not directely convert to json. Even if the framewrok
			// does do it for you, it a cross-cutting
	...
	public String updateTransaction(HttpServletRequest request, @RequestParam("amount") String amount,
			@RequestParam("date") String date, @RequestParam("description") String description,
			@RequestParam("withdraw") String withdraw, @RequestParam("deposit") String deposit,
