...
<body>
	...
	<br>
	<div id='jqxChart' style="width:99%; height:300px; position: relative; left: 0px; top: 0px;">
	</div>
	<br>
	<b>
	...
	<div id="toolbar">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newExpense()">New</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editExpense()">Edit</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="removeExpense()">Remove</a>
	</div>		
...
<!-- The dialoge ======================================================== -->
	...
	<div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveExpense(true)">Save</a>
