...
<body>
 ...
 --%>
		...
		<tr>
			...
			<td valign="top" width="25%">
				...
				<table id="tt" title="Accounts Tree" class="easyui-treegrid"
					data-options="idField:'id',treeField:'text'" showHeader="false"
					width="100%">
					<thead>
						<tr>
			...
			<td valign="top" width="70%">
				<div id="toolbar">
					<a href="#" class="easyui-linkbutton" iconCls="icon-add"
						plain="true" onclick="openNewExpenseDialog()">New</a> <a href="#"
						class="easyui-linkbutton" iconCls="icon-edit" plain="true"
						onclick="openEditExpenseDialog()">Edit</a> <a href="#"
						class="easyui-linkbutton" iconCls="icon-remove" plain="true"
						onclick="openRemoveExpenseDialog()">Remove</a>
				</div>

				<table id="dg" width="100%" class="easyui-datagrid"
					fitColumns="true" singleSelect="true" title="Transactions"
					toolbar="#toolbar">
					<thead>
						<tr>
	...
	<div id="dlg-buttons">
		<a id="save" href="#" class="easyui-linkbutton" iconCls="icon-ok"
