...
public class MockedMvcTest {
	...
	private final static Logger logger = Logger.getLogger(MockedMvcTest.class.getName());
...
//	  			.andExpect(content().contentType("text/html"))
  ...
  public void accountTransactions() throws Exception {
	...
	mockMvc.perform(MockMvcRequestBuilders.get("/rest/transactions/getTransactions.do")
			  	.param("account", accountId))
				.andExpect(MockMvcResultMatchers.status().is(200))//200 OK
				.andExpect(MockMvcResultMatchers.jsonPath("$.total", CoreMatchers.is("1")))
	  			.andExpect(MockMvcResultMatchers.jsonPath("$.rows[0].id", CoreMatchers.is("6d5a184b-7342-48e8-ac4d-2c5e3c7afb73")))//transactionId
	  			...
	  			.andExpect(MockMvcResultMatchers.jsonPath("$.rows[0].withdrawId", CoreMatchers.is("d2cedb8e-b049-464a-8142-c92814036047")))
	  			.andExpect(MockMvcResultMatchers.jsonPath("$.rows[0].depositId", CoreMatchers.is("52e2a234-498a-44da-abc2-5c95807ba531")))
  ...
  public void yearTransactions() throws Exception {
	...
	String accountId = "d2cedb8e-b049-464a-8142-c92814036047";
	mockMvc.perform(MockMvcRequestBuilders.get("/rest/transactions/getTransactions.do")
			  	.param("account", accountId).param("year", "2016"))
				.andExpect(MockMvcResultMatchers.jsonPath("$.total", CoreMatchers.is("1")))	  			
	  			;	  	
  }
